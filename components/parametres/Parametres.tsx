            ...
            <motion.div
                ...
                <SheetContent
                    ...
                    <div className="p-4 space-y-6">
                        ...
                        <div>
                            <h3 className="text-lg font-medium mb-4">Thème et carte</h3>

                            <div className="flex items-center justify-between p-3 border-b">
                                <span>Embouteillages sur la carte</span>
                                <Switch
                                    checked={embouteillageSurCarte}
                                    onCheckedChange={setEmbouteillageSurCarte}
                                />
                            </div>

                            <div className="p-3 border-b">
                                <span>Nettoyer le cache des cartes</span>
                            </div>

                            <div className="p-3 border-b">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="font-medium">Montrer au conducteur où je me trouve</p>
                                        <p className="text-sm text-gray-500">
                                            Le conducteur pourra voir votre emplacement jusqu'à ce que vous montiez dans le véhicule
                                        </p>
                                    </div>
                                    <Switch
                                        checked={montrerAuConducteur}
                                        onCheckedChange={setMontrerAuConducteur}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="p-3 border-b">
                                <div>
                                    <p className="font-medium">Activer dans les paramètres</p>
                                    <p className="text-sm text-gray-500">
                                        Vous recevrez des notifications sur les commandes, les remises et les actualités.
                                        Ici, vous pouvez également sélectionner quels types de notification vous souhaitez recevoir
                                    </p>
                                </div>
                                <span className="text-gray-400">›</span>
                            </div>
