...
import { getProducteurProductsByCode, getProducteurProductStats, getUserEnrollementDataByCode } from '@/api/services/productServices';
    ...
    return (
        <>
            <div className="w-full overflow-x-auto">
                ...
                <div className="flex items-center justify-between bg-[#B07B5E]/80 text-white font-semibold p-3 rounded-md">
                        ...
                        {!isVerified ? (
                            ...
                            <>
                                ...
                                <div className="w-full  max-w-6xl ">
                                    ...
                                    {activeTab === 'liste' && (
                                        <div>
                                            <h1 className="text-xl text-[#B07B5E] font-bold mb-1">LISTE DES PRODUITS</h1>
