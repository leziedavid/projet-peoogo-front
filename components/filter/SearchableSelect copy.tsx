...
export default function SearchFilter({
    ...
    // 🔄 Met à jour le champ de recherche et la sélection quand value change depuis l'extérieur
    useEffect(() => {
        if (value) {
    ...
    return (
        <div className="relative">
            <div className="relative">
                <button
                    type="button"
                    className={`w-full px-3 py-2 text-left bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-gray-300 pr-10 ${className}`}
                ...
                <div className="absolute z-20 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-80 overflow-hidden">
                    <div className="p-2 border-b border-gray-200">
                        <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-gray-300"
