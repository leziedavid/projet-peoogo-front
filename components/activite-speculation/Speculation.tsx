...
export default function Speculation() {
    ...
    const [speculation, setSpeculation] = useState<SousPrefectureResponse[]>([]);
    ...
    return (
        <>
            ...
            <div className="w-full overflow-x-auto">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>IMPORTER LES SPECULATIONS EN EXCEL</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div>
                            ...
                            {errors.fichiers && (
                                <p className="text-sm text-red-500">{errors.fichiers.message}</p>
                            )}
                ...
                <div className='mt-4'>
                    <h3 className="text-lg font-semibold">Lites des speculations</h3>
                    <p className="text-sm text-gray-600">{speculation.length} résultats trouvés</p>
                </div>
