...
export default function SupportInterface({ onClose, isOpen, types }: SecuriteProps) {
                            ...
                            <div className="p-4">
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <img src="/ride.png" alt="Vehicle" className="w-12 h-8 object-contain" />
                                    </div>
                                ...
                                <div className="mt-8">
                                    <p className="text-gray-500 text-sm mb-4">Messages du service d'assistance</p>
