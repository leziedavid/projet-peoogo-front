...
import { DollarSign, Youtube, Send, MessageSquare, Smartphone, ShoppingCart, Heart, SwatchBook, StretchHorizontal } from "lucide-react";
...
export default function DashboardProductAdmin({ userName, onChangeTab, activeTab, statistique }: DashboardProductGridProps) {
