...
const partenairesParDefaut: Partenaire[] = [
    ...
    },
    {
        id: '2',
        nom: '',
        logo: '/peoogo/generation.png',
        alt: 'generation',
        description: ''
    },
];

const NosPartenaires: React.FC<NosPartenairesProps> = ({ titre = "NOS PARTENAIRES", partenaires = partenairesParDefaut, className = "", autoPlay = true, showNavigation = true}) => {
    return (
                            ...
                            {partenaires.map((partenaire) => (
                                ...
                                >
                                    <div className="group">
                                        ...
                                        {/* Tooltip avec le nom du partenaire */}
                                        {/* <div className="mt-2 text-center">
                                            <p className="text-xs text-[#B07B5E]  font-medium line-clamp-2">
                                                {partenaire.nom}
                                            </p>
                                        </div> */}
                                    </div>
