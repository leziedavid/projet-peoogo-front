...
import { getAllOrders, getOrdersAndRevenueStatsEcommerce, getOrdersByCreator, getOrdersByUserId, getOrderStatsAndGains, updateOrderStatusEcommerce } from "@/api/services/authService";
...
export default function OrderList() {
    ...
    const getAllProduct = async () => {
        try {
            const res = await getOrdersByUserId(currentPage, limit);
            if (res.data) {
