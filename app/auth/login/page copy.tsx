                        ...
                        <div className="">
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-8 rounded-lg ">
                                ...
                                <div className="flex bg-gray-100 rounded-lg p-1 mb-6">
                                    <button type="button" onClick={() => setLoginMode('email')} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${loginMode === 'email' ? 'bg-white text-[#B07B5E] shadow-sm' : 'text-gray-600 hover:text-gray-900' }`} >
                                        <Mail className="h-4 w-4 inline mr-2" />
                                        Email
                                    </button>
                                    <button type="button" onClick={() => setLoginMode('phone')} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${loginMode === 'phone' ? 'bg-white text-[#B07B5E] shadow-sm' : 'text-gray-600 hover:text-gray-900' }`} >
                                ...
                                {loginMode === 'email' && (
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input id="email" type="email" {...register('email')} className="w-full py-3 pl-12 pr-4 text-base rounded-md border border-gray-300 outline-none focus:border-[#B07B5E] focus:ring-0 bg-white" placeholder="votre@email.com" />
                                        </div>
                                    ...
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <PhoneInput value={phoneValue} onChange={handlePhoneChange} placeholder="Numéro de téléphone" className="pl-10 focus:border-[#B07B5E]" />
                                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input id="password" type={showPassword ? 'text' : 'password'} {...register('password')} className="w-full py-3 pl-12 pr-12 text-base rounded-md border border-gray-300 outline-none focus:border-[#B07B5E] focus:ring-0 bg-white"  placeholder="Votre mot de passe" />
                                ...
                                <div className="text-right">
                                    <button type="button" onClick={() => { console.log('Mot de passe oublié'); }} className="text-sm text-[#B07B5E] hover:text-green-8000 font-medium" >
                                        Mot de passe oublié ?
                                    </button>
                                </div>

                                {/* Bouton de connexion */}
                                <Button type="submit" disabled={!isLoginFormValid()} className="w-full py-3 text-base font-medium bg-[#B07B5E] hover:bg-green-8000 disabled:opacity-50 disabled:cursor-not-allowed" >
                                    Se connecter
                                </Button>
                                ...
                                <div className="text-center">
                                    <p className="text-gray-600">
                                        ...
                                        <button type="button" onClick={() => { console.log('Redirection vers inscription'); }} className="text-[#B07B5E] hover:text-green-8000 font-medium" >
                                            Créer un compte
                                        </button>
                                    </p>
                                </div>
