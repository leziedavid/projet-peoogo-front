...
import {Lock,MenuIcon,User,Package,PlusSquare,ShoppingCart,ClipboardList,Heart,Star,Settings,MapPin,CalendarCheck,Eye} from 'lucide-react';
            ...
            <div className={`min-h-[calc(100vh_-_56px)] py-20`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12">
                    ...
                    <main className="col-span-9 p-4 relative">
                        ...
                        <div className="text-3xl font-bold mb-4">MON ESPACE PRODUCTEUR</div>

                        {/* Tabs */}
                        <div className="flex flex-wrap gap-2 mb-6">
                            <Button className="bg-orange-600 hover:bg-[#022d13] text-white">LISTE DES PRODUIT (2)</Button>
                            <Button variant="outline">AJOUTER UN PRODUIT</Button>
                            <Button variant="outline">LIESTE DES COMMANDES</Button>
                        </div>

                        {/* Liste Produits */}
                        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
                            <h1 className="text-xl font-bold mb-6">LISTE DES PRODUITS</h1>
